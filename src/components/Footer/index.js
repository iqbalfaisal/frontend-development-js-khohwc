  ...
  return (
    <div className="app-footer">
      <div className="content">
        <svg width="121" height="33" alt="Shortly's logo" className="logo">
          <path
            fill="white"
        ...
        <div className="social-links">
          <a href="/#">
            <img src={Images.facebook} alt="Facebook page" />
          </a>
          <a href="/#">
            <img src={Images.twitter} alt="Twitter page" />
          </a>
          <a href="/#">
            <img src={Images.pinterest} alt="Pinterest page" />
          </a>
          <a href="/#">
            <img src={Images.instagram} alt="Instagram page" />
          </a>
        </div>
      </div>
    </div>
